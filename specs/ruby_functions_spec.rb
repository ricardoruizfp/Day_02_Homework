...
#
  ...
  def test_volume_of_cube()
    #add test code here
    cube_volume_result = volume_of_cube(10)
    assert_equal(1000,cube_volume_result)
  end
  ...
  def test_volume_of_sphere()
    ...
    assert_equal(4188.790204786391,sphere_volume_result)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    celsius_result = fahrenheit_to_celsius(73)
    assert_equal(22.77777777777778,celsius_result)#add test code here
  end
end
